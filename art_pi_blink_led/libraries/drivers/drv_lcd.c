...
#include <rtdevice.h>
#include <string.h>
static uint16_t LCD_BUFFER1[600][1024] __attribute__((at(0XC0000000)));
static uint16_t LCD_BUFFER2[600][1024] __attribute__((at(0XC0000000 + 600 * 1024 * 2)));
static uint16_t LCD_BUFFER3[600][1024] __attribute__((at(0XC0000000 + 600 * 1024 * 2 * 2)));
...
int drv_lcd_hw_init(void)
{
	...
	#if BSP_LCD_STATIC_SDRAM
	_lcd.lcd_info.framebuffer = (rt_uint8_t *)LCD_BUFFER1;
    _lcd.back_buf = (rt_uint8_t *)LCD_BUFFER2;
    _lcd.front_buf = (rt_uint8_t *)LCD_BUFFER3;
	#else
